...
const group_handler_1 = require("../../handler/group/group.handler");
...
exports.default = [
    {
        ...
        handler: async (req, res, next) => {
            ...
            // }
            redis_service_1.redisListResponse(req, res, next, group_handler_1.groupSearchHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, group_handler_1.groupFilterHandler);
        },
    },
    {
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, group_handler_1.groupDifferenceHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, group_handler_1.groupGetByIDHandler);
        },
    },
];
