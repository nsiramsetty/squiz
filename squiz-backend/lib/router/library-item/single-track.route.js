...
const single_track_handler_1 = require("../../handler/library-item/single-track.handler");
...
exports.default = [
    {
        ...
        handler: async (req, res, next) => {
            redis_service_1.redisListResponse(req, res, next, single_track_handler_1.singleTrackSearchHandler);
        },
    },
    {
        /**
        ...
        method: 'GET',
        handler: async (req, res, next) => {
            redis_service_1.redisListResponse(req, res, next, single_track_handler_1.singleTrackFilterHandler);
        },
    },
    {
        /**
        ...
        method: 'GET',
        handler: async (req, res, next) => {
            redis_service_1.redisObjectResponse(req, res, next, single_track_handler_1.singleTrackGetByIDHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            // }
            redis_service_1.redisObjectResponse(req, res, next, single_track_handler_1.singleTrackPublisherProfileHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, single_track_handler_1.singleTrackReviewsHandler);
        },
    },
];
//# sourceMappingURL=single-track.route.js.map