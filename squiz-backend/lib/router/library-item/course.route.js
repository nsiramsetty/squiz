...
const course_handler_1 = require("../../handler/library-item/course.handler");
...
exports.default = [
    {
        ...
        handler: async (req, res, next) => {
            ...
            // }
            redis_service_1.redisListResponse(req, res, next, course_handler_1.courseSearchHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, course_handler_1.courseFilterHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, course_handler_1.courseGetByIDHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, course_handler_1.coursePublisherProfileHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, course_handler_1.courseReviewsHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, course_handler_1.courseDaysHandler);
        },
    },
];
