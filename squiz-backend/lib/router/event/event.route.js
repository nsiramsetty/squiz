...
const event_handler_1 = require("../../handler/event/event.handler");
...
exports.default = [
    {
        ...
        handler: async (req, res, next) => {
            ...
            // }
            redis_service_1.redisListResponse(req, res, next, event_handler_1.eventSearchHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            if (req.query.start_date_from) {
                query_parameter_parser_1.interceptEventQueryParams(req, 'start_date_from');
                isTimeBased = true;
            }
            if (req.query.start_date_to) {
                query_parameter_parser_1.interceptEventQueryParams(req, 'start_date_to');
                isTimeBased = true;
            }
            if (req.query.end_date_from) {
                query_parameter_parser_1.interceptEventQueryParams(req, 'end_date_from');
                isTimeBased = true;
            }
            if (req.query.end_date_to) {
                query_parameter_parser_1.interceptEventQueryParams(req, 'end_date_to');
                isTimeBased = true;
            }
            if (isTimeBased) {
                redis_service_1.redisListResponse(req, res, next, event_handler_1.eventFilterHandler, { cacheDuration: 600, recacheInterval: 300 });
            }
            else {
                redis_service_1.redisListResponse(req, res, next, event_handler_1.eventFilterHandler);
            }
        },
    },
    {
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, event_handler_1.eventGetByIDHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, event_handler_1.homeCarouselEventsHandler);
        },
    },
];
