...
const publisher_handler_1 = require("../../handler/user/publisher.handler");
...
exports.default = [
    {
        ...
        handler: async (req, res, next) => {
            ...
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.publisherSearchHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.publisherFilterHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, publisher_handler_1.getPublisherHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.getPublisherPlaylistsHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.getPublisherCoursesHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.getPublisherDailyInsightsHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.getPublisherLibraryItemsHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.getPublisherGratitudeWallHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, publisher_handler_1.getPublisherLiveEventsHandler);
        },
    },
];
