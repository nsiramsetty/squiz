...
const user_handler_1 = require("../../handler/user/user.handler");
...
exports.default = [
    {
        ...
        handler: async (req, res, next) => {
            ...
            // }
            redis_service_1.redisListResponse(req, res, next, user_handler_1.userSearchHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisObjectResponse(req, res, next, user_handler_1.userGetByIDHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, user_handler_1.getUserCoursesHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, user_handler_1.getUserGroupsHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, user_handler_1.getUserFriendsHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, user_handler_1.getUserFollowersHandler);
        },
    },
    {
        /**
        ...
        handler: async (req, res, next) => {
            ...
            //   errorHandler(error, req, res, next);
            // }
            redis_service_1.redisListResponse(req, res, next, user_handler_1.getUserFollowingsHandler);
        },
    },
];
