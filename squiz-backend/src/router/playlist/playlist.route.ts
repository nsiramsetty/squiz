...
import {
  otherPlaylistByIDHandler,
  playlistFilterHandler,
  playlistGetByIDHandler,
  playlistSearchHandler,
  relatedPlaylistByIDHandler,
} from '../../handler/playlist/playlist.handler';
...
export default [
  {
    ...
    handler: async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      ...
      // }
      redisListResponse(req, res, next, playlistSearchHandler);
    },
  },
  {
    /**
    ...
    handler: async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      ...
      //   errorHandler(error, req, res, next);
      // }
      redisListResponse(req, res, next, playlistFilterHandler);
    },
  },
  {
    /**
    ...
    handler: async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      ...
      //   errorHandler(error, req, res, next);
      // }
      redisObjectResponse(req, res, next, playlistGetByIDHandler);
    },
  },
  {
    /**
    ...
    handler: async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      ...
      //   errorHandler(error, req, res, next);
      // }
      redisListResponse(req, res, next, relatedPlaylistByIDHandler);
    },
  },
  {
    /**
    ...
    handler: async (req: Request, res: Response, next: NextFunction): Promise<void> => {
      ...
      //   errorHandler(error, req, res, next);
      // }
      redisListResponse(req, res, next, otherPlaylistByIDHandler);
    },
  },
];
